...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <!-- Category Info -->
            <div class="category-info " id="about">
                <h3 class="category-title"> About
                    <!-- Fragment Identifier -->
                    <a class="fragment-identifier js-fragment-identifier " href="#about"><i class="fa fa-link"></i></a>
                    <!-- End of Fragment Identifier -->
                </h3>
                <h4 class="category-description">Bootstrap makes front-end web development faster and easier. It's made for folks of all skill levels, devices of all shapes, and projects of all sizes.</h4>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="box helper center">
                        <i class="fa fa-gears box-icon-large"></i>
                        <h4 class="box-title">Nested</h4>
                        <p class="box-description">This is the first example of boxes with Title, Content and a small font-awesome icon. All the content is aligned center.</p>
                    </div>
                    <!-- End of Box -->
                </div>
                <div class="col-md-4">
                    <!-- Box -->
                    <div class="box helper center">
                        <i class="fa fa-bug box-icon-large"></i>
                        <h4 class="box-title">Colors</h4>
                        <p class="box-description">This is the second example of boxes with Title, Content and a small font-awesome icon. All the content is aligned center.</p>
                    </div>
                    <!-- End of Box -->
                </div>
                <div class="col-md-4">
                    <!-- Box -->
                    <div class="box helper center">
                        <i class="fa fa-paper-plane box-icon-large"></i>
                        <h4 class="box-title">Components</h4>
                        <p class="box-description">This is the third example of boxes with Title, Content and a small font-awesome icon. All the content is aligned center.</p>
                    </div>
                    <!-- End of Box -->
                </div>
            </div>
            <!-- Category Info -->
            <div class="category-info " id="bootstrap-cdn">
                <h3 class="category-title"> Bootstrap CDN
                    <!-- Fragment Identifier -->
                    <a class="fragment-identifier js-fragment-identifier " href="#bootstrap-cdn">
                        <i class="fa fa-link"></i>
                    </a>
                    <!-- End of Fragment Identifier -->
                </h3>
                <h4 class="category-description">The folks over at MaxCDN graciously provide CDN support for Bootstrap's CSS and JavaScript. Just use these Bootstrap CDN links.</h4>
            </div>
            <!-- End of Caregory Info -->
            <!-- HTML Highlight -->
            <div class="code-highlight">
                <span class="js-copy-to-clipboard copy-code">copy</span> <pre><code class="language-markup">&lt;!-- Latest compiled and minified CSS --&gt;
            ...
            <!-- End of HTML Highlight -->
            <!-- Category Info -->
            <div class="category-info " id="file-hierarchy">
                <h3 class="category-title"> File hierarchy
                    <!-- Fragment Identifier -->
                    <a class="fragment-identifier js-fragment-identifier " href="#file-hierarchy">
                        <i class="fa fa-link"></i>
                    </a>
                    <!-- End of Fragment Identifier -->
                </h3>
                <h4 class="category-description">Once downloaded, unzip the compressed folder to see the structure of (the compiled) Bootstrap. You'll see something like this:</h4>
            </div>
            <!-- End of Caregory Info -->
            <!-- Note -->
            ...
            <div class="file-tree">
                ...
                <ul class="file-tree-list js-file-tree" data-expanded="">
                    <li class="is-folder">css -
                        ...
                        <ul>
                            <li class="is-file">custom.css -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                            <li class="is-file">style.css -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                        </ul>
                    </li>
                    <li class="is-folder">fonts -
                        <span class="file-tree-description">lorem ipsum dolor sit amet, consectetur.</span>
                        <ul>
                            <li class="is-file">fontawesome.otf -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                            <li class="is-file">fontawesome-webfont.eot -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                        </ul>
                    </li>
                    <li class="is-folder">img -
                        <span class="file-tree-description">lorem ipsum dolor sit amet, consectetur.</span>
                        <ul>
                            <li class="is-file">img1.jpg -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                            <li class="is-file">img2.png -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                        </ul>
                    </li>
                    <li class="is-folder">js -
                        <span class="file-tree-description">lorem ipsum dolor sit amet, consectetur.</span>
                        <ul>
                            <li class="is-file">all.js -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                            <li class="is-file">custom.js -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                        </ul>
                    </li>
                    <li class="is-folder">less -
                        <span class="file-tree-description">lorem ipsum dolor sit amet, consectetur.</span>
                        <ul>
                            <li class="is-file">custom.less -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                            <li class="is-file">style.less -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                        </ul>
                    </li>
                    <li class="is-folder">swf -
                        <span class="file-tree-description">lorem ipsum dolor sit amet, consectetur.</span>
                        <ul>
                            <li class="is-file">zeroclipboard.swf -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                        </ul>
                    </li>
                    <li class="is-file">index-1.html -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                    <li class="is-file">index-2.html -<span class="file-tree-description">lorem ipsum dolor sit amet.</span></li>
                </ul>
            </div>
            <!-- End of FIle Tree -->
            <!-- Category Info -->
            <div class="category-info " id="table-with-properties">
                <h3 class="category-title"> Table with properties
                    <!-- Fragment Identifier -->
                    <a class="fragment-identifier js-fragment-identifier " href="#table-with-properties"><i class="fa fa-link"></i></a>
                    <!-- End of Fragment Identifier -->
                </h3>
            ...
            <div class="category-info " id="browser-support">
                <h3 class="category-title"> Browser support
                    <!-- Fragment Identifier -->
                    <a class="fragment-identifier js-fragment-identifier " href="#browser-support">
                        <i class="fa fa-link"></i>
                    </a>
                    <!-- End of Fragment Identifier -->
                </h3>
            ...
            <div class="category-info " id="FAQ">
                <h3 class="category-title"> FAQ
                    <!-- Fragment Identifier -->
                    <a class="fragment-identifier js-fragment-identifier " href="#FAQ">
                        <i class="fa fa-link"></i>
                    </a>
                    <!-- End of Fragment Identifier -->
                </h3>
