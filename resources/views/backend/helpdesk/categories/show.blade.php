                ...
                <form action="{{ url('admin/categorie/'.$categorie->id) }}" method="POST" class="form-horizontal" >
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" value="{{ $categorie->name }}" required class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                {!! Form::text('color', $categorie->color , array('required' => 'required','class' => 'form-control colorpicker') ) !!}
                            </div>
                        </div>

                    </div>
                    <div class="panel-footer mini-footer ">
                        <div class="col-sm-3">{!! Form::hidden('id', $categorie->id ) !!}</div>
                        <div class="col-sm-9">
